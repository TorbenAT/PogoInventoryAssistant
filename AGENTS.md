...
- The current Device Harness is read-only. Do not add taps, swipes or text input until a later explicitly approved milestone.
- Preserve the fake transport and package-free self-tests.
