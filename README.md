...
Version 0.6.2 adds the first automatic phone-navigation engine. Once the two local profiles are adjusted to the fixed Android phone, the program can open the first Pokémon, open appraisal, swipe through the inventory, capture every item and stop or resume without user interaction per Pokémon.
...
Version 0.6.2 captures the inventory evidence and sequence. It does not yet extract species, CP, IVs, moves or special status from every captured Pokémon. Calcy integration and observation extraction are the next milestone.
