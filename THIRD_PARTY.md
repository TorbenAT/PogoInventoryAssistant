...
Version 0.14.0 contains no copied source code from PGo-CalcaBotaBotaCalca, Calcy IV, PvPoke, Ohbem, scrcpy or other external projects.
...
Version 0.14.0 defines original probe, raw-output and parser boundaries for Calcy IV. It does not copy Calcy IV code and does not claim an undocumented integration method is working.
