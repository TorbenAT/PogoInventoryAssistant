...
Version 0.6.0 records ordered evidence. The next layer will turn each evidence item into a structured Pokémon observation using Calcy and visual extraction.
