...
Version 0.11.0 has three separate interfaces.
...
The interface does not expose arbitrary shell commands. Version 0.11.0 uses it only for the local Calcy evidence probe.
