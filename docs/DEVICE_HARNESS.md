...
Version 0.10.1 has three separate interfaces.
...
The interface does not expose arbitrary shell commands. Version 0.10.1 uses it only for the local Calcy evidence probe.
