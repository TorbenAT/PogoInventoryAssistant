...
Version 0.12.0 provides a deterministic pretest for uncropped iPhone Pokémon GO screenshots.
...
Version 0.12.0 accepts this as a useful pretest set while preserving the one rejected file for decoder investigation.
