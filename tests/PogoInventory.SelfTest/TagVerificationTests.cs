...
internal static class TagVerificationTests
{
    public static async Task RunAsync()
    {
        ...
        try
        {
            ...
            AssertEqual(4L, await ReadSchemaVersionAsync(databasePath), "schema version migrates to current version");
            await persistence.InitializeAsync();
            AssertEqual(4L, await ReadSchemaVersionAsync(databasePath), "migration is idempotent");
